...
export class SynthCircuitView {
    ...
    constructor(djs, panel, document) {
        // Document is JSON object from Yosys synth
        this.#panel = panel;
        ...
        this.#processCommand(djs, { command: 'do-viewsynth' })
    }
    get panel() {
        return this.#panel;
    }
    ...
    #processCommand(djs, msg) {
        ...
        // Not handled yet, so pass back to document. 
